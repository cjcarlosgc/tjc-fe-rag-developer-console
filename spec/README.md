...
- [`contracts/system-contract.md`](contracts/system-contract.md): copia espejo `SYSTEM-1.6` del contrato común de los tres componentes; su propietario canónico es RAG Core.
- [`contracts/interoperability-contract.md`](contracts/interoperability-contract.md): copia espejo `INTEROP-1.6` con rutas, DTOs, estados, errores y transporte universales.
