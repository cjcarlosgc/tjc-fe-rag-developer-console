...
- [x] Formulario live conectado a `POST /experiments` de `INTEROP-1.5` con `targetId` real e `Idempotency-Key` por acción. Verificado contra RAG Core local real (experimento completo 6/6 repeticiones).
