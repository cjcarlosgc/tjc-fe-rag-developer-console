...
5. Implementar con agentes compatibles en paralelo; cada agente entrega evidencia. Hacer Contract Sync `implementation-delivery`, luego `before-review`; el reviewer independiente y revisores especializados pueden actuar en paralelo.
