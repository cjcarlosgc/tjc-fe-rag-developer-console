...
La experiencia debe ser informativa y técnica, inspirada en herramientas de análisis de código: alta densidad útil, jerarquía proyecto -> versión -> run -> resultado -> artifact, estados explícitos y trazabilidad del contexto/resultados.
