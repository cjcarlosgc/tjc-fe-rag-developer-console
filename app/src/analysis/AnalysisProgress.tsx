...
import { GraphPulseIcon, Spinner } from '../ui/Loaders'
...
export function AnalysisProgress({ projectVersionId, initialPollAfterMs }: Props) {
  ...
  if (!operation) return <div className="analysis-progress" role="status"><div className="progress-header"><GraphPulseIcon /> Conectando con ProjectVersion…</div></div>
