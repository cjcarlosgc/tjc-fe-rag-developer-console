...
export interface RepetitionResult { target: string; repetition: 1 | 2 | 3; strategy: ExperimentStrategy; valid: boolean; failureType: FailureType; durationMs: number; totalTokens: number | null }
